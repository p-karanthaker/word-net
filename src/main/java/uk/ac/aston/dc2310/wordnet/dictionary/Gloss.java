...
/**
 * The Gloss class models a "gloss" (meaning) of a particular Synset.
 * The data is collected from the wn_g.csv file.
 * 
 * @author KTHAKER
 *
 */
public class Gloss {
	...
	/**
	 * The constructor for a Gloss object. Constructed by passing in 3 columns from
	 * the wn_g.csv file.
	 * 
