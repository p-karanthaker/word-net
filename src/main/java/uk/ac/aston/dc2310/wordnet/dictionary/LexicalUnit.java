...
/**
 * The LexicalUnit class models a single lexical unit from the wn_s.csv WordNet file.
 * 
 * @author KTHAKER
 *
 */
public class LexicalUnit {
  ...
  /**
   * The sense number. If the the sense number is lower, then it is used more than a lexical unit
   * with the same name but a higher sense number.
   */
  private byte senseNumber;

  /**
   * The constructor for a LexicalUnit object. Constructed by passing in the 3 columns retrieved
   * when parsing the wn_s.csv file.
   * 
