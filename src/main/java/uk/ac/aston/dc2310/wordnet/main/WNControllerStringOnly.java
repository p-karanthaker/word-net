...
public interface WNControllerStringOnly {
	 ...
	 * @return	a String representation of a set of word senses representing the meanings of the specified word; a simple String message if no meanings found.
	 */
	public abstract String getMeanings(String word);

	/**
	 * Returns a set of senses (i.e. meanings) for a specified word in a specified 
	 * syntactic category (i.e. part-of-speech such as noun, verb, adjective and adverb).
	 * 
	 * @param word	a sequence of characters corresponding to an English word
	 * @param pos	a specified part-of-speech (noun, verb, adjective and adverb)
	 * @return	a String representation of a set of word senses representing the meanings of the specified word in a specified part-of-speech; a simple String if no meanings found.
	 */
	 ...
	 * 
	 * @param word	a sequence of characters corresponding to an English word
	 * @return	a String representation of a set of synsets representing the direct hypernyms of the specified word; a simple String message if no direct hypernyms are found
	 */
	 ...
	 * i.e. the less general a concept, the closer to the front of the list, with the 
	 ...
	 * 
	 * @param synsetId
	 * @return	a String representation of a list of Synset objects sorted in an ascending order of their generality; a simple String message if no hypernym for the specified synset is found; 
	 */
