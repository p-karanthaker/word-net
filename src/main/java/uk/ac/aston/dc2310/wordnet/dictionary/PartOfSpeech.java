...
/**
 * PartOfSpeech shows the parts of speech which are used within this implementation of WordNet and
 * the value which maps the first digit in the Synset ID to the part-of-speech.
 * 
...
public enum PartOfSpeech {
  ...
  /**
   * Get the value which maps the first digit in the Synset ID to the part-of-speech.
   * 
